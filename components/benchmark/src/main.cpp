 ...
 *
 * Just: "${PATH_TO_BINARY}/benchmark --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class benchmark : public RoboComp::Application
{
public:
	benchmark (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::benchmark::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
