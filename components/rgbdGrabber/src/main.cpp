...
/** \mainpage RoboComp::rgbdGrabber
 *
 * \section intro_sec Introduction
 *
 * The rgbdGrabber component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/rgbdGrabber --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class rgbdGrabber : public RoboComp::Application
{
public:
	rgbdGrabber (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::rgbdGrabber::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
