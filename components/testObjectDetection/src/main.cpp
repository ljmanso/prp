...
/** \mainpage RoboComp::testObjectDetectionComp
 *
 * \section intro_sec Introduction
 *
 * The testObjectDetectionComp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/testObjectDetectionComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	testObjectDetectionComp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::testObjectDetectionComp::initialize()
{
...
int ::testObjectDetectionComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::testObjectDetectionComp app(prefix);
