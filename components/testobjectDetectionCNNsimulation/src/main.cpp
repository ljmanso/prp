...
/** \mainpage RoboComp::testODCNNsimulation
 *
 * \section intro_sec Introduction
 *
 * The testODCNNsimulation component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/testODCNNsimulation --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class testODCNNsimulation : public RoboComp::Application
{
public:
	testODCNNsimulation (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::testODCNNsimulation::initialize()
{
...
int ::testODCNNsimulation::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::testODCNNsimulation app(prefix);
